# Proyecto: Propuesta metodológica basada en Redes Neuronales Artificiales para la determinación de la gestión adecuada de los residuos sólidos urbanos en zonas de recolección de la ciudad de Bogotá.  

El siguiente proyecto inicialmente estructura y analiza los datos proporcionados sobre recolección de residuos sólidos en la ciudad de Bogotá. Seguido, se seleccionan, se implementan y entrenan modelos basados en algunos algoritmos de **Aprendizaje de máquina** y **Redes Neuronales** más convenientes. Finalmente, se generan predicciones futuras y se caracterizan los residuos en base a los resultados obtenidos.  
